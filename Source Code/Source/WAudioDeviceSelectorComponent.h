...
#ifndef JUCE_WAUDIODEVICESELECTORCOMPONENT_H_INCLUDED
#define JUCE_WAUDIODEVICESELECTORCOMPONENT_H_INCLUDED
...
*/
class JUCE_API  WAudioDeviceSelectorComponent  : public Component,
...
public:
    ...
    */
	WAudioDeviceSelectorComponent(AudioDeviceManager& deviceManager,
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WAudioDeviceSelectorComponent)
};
